...
The locale priority order is URL parameters, user settings,
request headers, and default locale.
"""
...
def get_locale():
    ...
    Returns:
        str: The locale that matches the URL parameters,
        user settings, request header, or the default locale.
    """
